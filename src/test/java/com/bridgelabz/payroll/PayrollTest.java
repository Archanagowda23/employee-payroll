...
public class PayrollTest {
    ...
    public void given3EmployeesWhenWrittenToFileShouldMatchEmployeesEntries() {
        ...
        EmployeePayrollService.write(com.bridgelabz.payroll.EmployeePayrollService.IOService.FILE_IO);
        long entriesCount=EmployeePayrollService.countEntries(com.bridgelabz.payroll.EmployeePayrollService.IOService.FILE_IO);
        EmployeePayrollService.printData(com.bridgelabz.payroll.EmployeePayrollService.IOService.FILE_IO);
